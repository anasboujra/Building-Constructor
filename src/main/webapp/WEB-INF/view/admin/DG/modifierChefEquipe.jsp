            ...
            <div id="content">
                ...
                <div class="container-fluid ">
                    ...
                    <div class="row justify-content-center  p-5 mb-5 ">
                        ...
                        <form method="post" action="dg-update-chef">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="nom">Nom</label>
                                    <input type="text" class="form-control" id="nom" name="nom" placeholder="Nom" value="${ ce.nom }">
                                    <!--div  class="text-danger form-text px-3">${erreurs.nom}</div-->
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="prenom">Prenom</label>
                                    <input type="text" name="prenom" class="form-control" id="prenom" placeholder="Prenom" value="${ ce.prenom }" >
                                	<!--div  class="text-danger form-text px-3">${erreurs.prenom}</div-->
                                </div>                       
                                <div class="form-group col-md-4">
                                    <label for="email">Email</label>
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="${ ce.email }">
                                	<!--div  class="text-danger form-text px-3">${erreurs.email}</div-->
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="tele">Telephone</label>
                                    <input type="text" class="form-control" name="tele" id="inputCity" placeholder="06-XXXXXXX" value="${ ce.tele }">
                                	<!--div  class="text-danger form-text px-3">${ce.tele}</div-->
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="cin">CIN</label>
                                    <input type="text" name="cin" class="form-control" id="cin"value="${ ce.cin }">
