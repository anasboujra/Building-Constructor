                ...
                <div class="container-fluid">
                    ...
                    <c:if test="${ message=='success' }">
                      <div  class="text-light bg-success text-center p-2 mb-2 mt-4">
                        Paiement de crédit avec succès
                      </div>
                    </c:if>
                    <c:if test="${ message=='failed' }">
                          <div  class="text-light bg-danger text-center p-2 mb-2 mt-4">
                             Opération échoué : Les informations sont érroné
                          </div>                      
                    </c:if>                    
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">$ ${ sessionScope.RMensuel }</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">$ ${ sessionScope.RAnnuel }</div>
                                        </div>
                                        <div class="col-auto">
