            ...
            <div id="content">
                ...
                <div class="container-fluid ">
                    ...
                    <div class="row justify-content-center  p-5 mb-5 ">
                        ...
                        <form method="post" action="dg-update-rh">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="nom">Nom</label>
                                    <input type="text" class="form-control" id="nom" name="nom" placeholder="Nom" value="${ rh.nom }">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="prenom" class="form-control" id="prenom" placeholder="Prenom" value="${ rh.prenom }" >
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="${ rh.email }">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="tele" id="inputCity" placeholder="06-XXXXXXX" value="${ rh.tele }">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="cin" class="form-control" id="cin"value="${ rh.cin }">
