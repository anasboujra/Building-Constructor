            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-client-image"></div>
                            <div class="col-lg-6">
                                <div class="px-5 pt-5 pb-4">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Se connecter</h1>
                                    </div>
                                    <form method="post" action="login-client" class="user">
                                        ...
                                        <button type="submit" class="btn btn-user btn-block text-light" id="connexionBtn">Connexion</button>
                                        <c:if test="${!empty form.resultat}">
											<div class="alert alert-danger mx-5 mt-3 text-center" role="alert">${form.resultat}</div>
										</c:if>
                                        <hr>
                                        <a href="login-admin" class="btn btn-comme btn-user btn-block">Se connecter comme un admin</a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
